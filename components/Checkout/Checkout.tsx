...
export default function Checkout() {
    ...
    return (
        ...
        <div className="mx-auto px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <form action="/checkout/payment-method" className="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16">
                {/* Order summary */}
                ...
                <div className="max-w-6xl">
                    <div className="mt-4 rounded-lg border border-gray-200 bg-white shadow-sm">
                        ...
                        <h2 className="text-2xl font-bold ml-5 mt-5 mb-5 text-gray-900">Contact Details</h2>
                        ...
                        <div className="space-y-6 border-gray-200 px-4 py-6 sm:px-6">
                            ...
                            <div className="mt-6 flex items-center">
                                ...
                                <div className="ml-2">
                                    <label htmlFor="same-as-shipping" className="text-sm font-medium text-gray-900">
                                        I have read and agree with the Points <Link className="underline" href="/"> Terms & Conditions</Link> and the<Link className="underline" href="/"> Privacy Policy.</Link>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className=" border-gray-200 px-4 py-6 sm:px-6">
                            <button
                                type="submit"
                                className="w-64 rounded-full border border-transparent bg-[#2a7671] px-4 py-3 text-base font-medium text-white shadow-sm hover:bg-[#eecb25] focus:outline-none focus:ring-2 focus:ring-[#eecb25] focus:ring-offset-2 focus:ring-offset-gray-50"
                            >
                                Continue to payment
                            </button>
                        </div>
