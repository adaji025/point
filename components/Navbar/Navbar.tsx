...
export default function Navbar() {
  return (
    <Disclosure as="nav" className="bg-[#0e7f6e] shadow">
      {({ open }) => (
        <>
...
<h1 className="font-extrabold text-4xl text-white">POINTS </h1>
                </div>
                <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                  ...
                  <a
                    href="#"
                    className="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-white hover:border-gray-300 hover:text-white"
                  >
                    Team
                  </a>
                  <a
