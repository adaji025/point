...
export default function ThemeDropdown() {
  ...
  return (
    <div className="text-right">
      ...
      >
        <div>
          <Menu.Button className="inline-flex gap-2 items-center justify-between rounded-md bg-black bg-opacity-20 px-4 py-2 text-sm font-medium text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 capitalize">
